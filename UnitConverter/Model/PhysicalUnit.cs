...
namespace UnitConverter.Model
{
    public class PhysicalUnit
    {
        ...
        public static double Convert(double inputValue, PhysicalUnit inputUnit, PhysicalUnit outputUnit)
        {
            if (inputUnit.RelationToBaseWithConstant != null || inputUnit.RelationToBaseWithConstant != null)
            {
                return Math.Round(
                    (inputValue * inputUnit.RelationToBaseWithConstant[0] + inputUnit.RelationToBaseWithConstant[1]) / outputUnit.RelationToBaseWithConstant[0] -
                    outputUnit.RelationToBaseWithConstant[1] / outputUnit.RelationToBaseWithConstant[0], 12);
            }
            return Math.Round(inputValue * inputUnit.RelationToBase / outputUnit.RelationToBase, 12);
        }
    }
